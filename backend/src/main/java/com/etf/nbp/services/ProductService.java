...
import com.etf.nbp.dto.ProductDTO;
import com.etf.nbp.dto.ProductRowDTO;
import com.etf.nbp.repositories.BidRepository;
import com.etf.nbp.repositories.ImageRepository;
import com.etf.nbp.repositories.ProductRepository;
import com.etf.nbp.utils.MapperUtil;
import com.etf.nbp.utils.TimeDifferenceUtil;
...
public class ProductService  {
    ...
    public List<ProductRowDTO> getProductRows(int page, int limit, String status) {
        ...
        for (Product product : products.getContent()) {
            ...
            row.setBidders(bidRepository.findDistinctUserByProductId(product.getId()).size());
